...
const leaderboardData = [
    { rank: 1, name: 'Alex Chen', avatar: 'AC', points: 850, tasks: 6, time: '45m 32s' },
...
class Leaderboard {
    ...
    attachEventListeners() {
        document.getElementById('sort-points').addEventListener('click', (event) => this.sort('points', event));
        document.getElementById('sort-tasks').addEventListener('click', (event) => this.sort('tasks', event));
        document.getElementById('sort-time').addEventListener('click', (event) => this.sort('time', event));
    }
