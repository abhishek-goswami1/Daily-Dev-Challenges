...
const Navbar = () => {
  ...
  // Handle scroll to add background opacity / drop shadow to navbar when scrolling down
  useEffect(() => {
    const handleScroll = () => {
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button className="px-6 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-[var(--color-primary)] to-[#5249e5] hover:shadow-[0_0_15px_var(--color-primary)] transition-all duration-300 transform hover:-translate-y-0.5">
            Resume
          </button>
        </div>
